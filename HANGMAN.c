...
{	
{
      ...
      printf("\n   2: YOU WILL HAVE TO GUESS ALL THE CORRECT WORDS TO WIN.\n");
      printf("   3: HOPE YOU WILL ENJOY GAME.\n");
}
	Game game = {
		"",	// secretWord
		"",	// knownWord
			...
			if (game.mistakes == 6) {
				...
				printf("The word was: %s\n", game.secretWord);
						...
						printf("       \\_______/           \n");
           		      	  printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ SUBMITTED BY ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n");
				  printf("                                 DEVANSH JAIN                                \n");
				  printf("                         PRINCE JAIN  |  HEMANT PARAKH                       \n\n");
				  printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ MOODLE ID. ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n");
				  printf("                                   19102024                                   \n");
				  printf("                           19102020  |  19102048                              \n\n");
				  printf("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ MINI PROJECT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n");
				  printf("                              HANGMAN Game using C                               \n");
				  printf("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ INSTITUTE ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n");
				  printf("            A P SHAH INSTITUTE OF TECHNOLOGY, KASARVADAVALI,THANE WEST         \n\n");
 				printf("If You Want To Play Again Press y: \nElse Any:");
				scanf("%c", &c);
				getchar();
